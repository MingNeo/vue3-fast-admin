 ...
 */
export const USERNAME_REGEX = /^\w{5,20}$/

/**
 * 密码包含数字、非重复字母和特殊字符，且长度为8~16个字符。
 * @example "my_Passw0rd!"
 */
 ...
 * @example ""
 */
export const LANDLINE_PHONE_NUMBER_REGEX = /^((0\d{2,3}(-)?\d{7,8})|(13\d|14[014-9]|15[0-35-9]|16[2567]|17[0-8]|18\d|19[0-35-9])\d{8})$/

/**
 * 身份证号码必须符合中国公民身份证号码的规范。
 * @example "35018119880101234X"
 */
export const ID_CARD_REGEX = /(^\d{15}$)|(^\d{18}$)|(^\d{17}([\dX])$)/i
